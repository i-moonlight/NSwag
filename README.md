...
NSwag | [NJsonSchema](http://njsonschema.org) | [Apimundo](https://apimundo.com) | [Namotion.Reflection](https://github.com/i-moonlight/Namotion.Reflection)
...
[![build](https://github.com/i-moonlight/NSwag/actions/workflows/build.yml/badge.svg)](https://github.com/i-moonlight/NSwag/actions/workflows/build.yml)
...
[![Wiki](https://img.shields.io/badge/docs-in%20wiki-orange.svg?style=flat)](https://github.com/i-moonlight/nswag/wiki)
...
:point_right: [**Announcing Apimundo:** An API documentation system based on NSwag and NJsonSchema](https://github.com/i-moonlight/NSwag/issues/3077) :point_left:
...
- [Generate Swagger 2.0 and OpenAPI 3.0 specifications from C# ASP.NET (Core) controllers](https://github.com/i-moonlight/NSwag/wiki/Middlewares)
...
- Simple to use Windows GUI, [NSwagStudio](https://github.com/i-moonlight/NSwag/wiki/NSwagStudio)
- By using the [OpenAPI or OpenAPI UI OWIN and ASP.NET Core Middlewares](https://github.com/i-moonlight/NSwag/wiki/Middlewares) (also serves the [Swagger UI](https://github.com/swagger-api/swagger-ui)) (recommended)
- Via [command line](https://github.com/i-moonlight/NSwag/wiki/CommandLine) (Windows, Mac and Linux support through [Mono](http://www.mono-project.com/) or .NET Core console binary, also via [NPM package](https://www.npmjs.com/package/nswag))
- In your C# code, via [NuGet](https://www.nuget.org/packages?q=NSwag)
- In your [MSBuild targets](https://github.com/i-moonlight/NSwag/wiki/NSwag.MSBuild)
- With [ServiceProjectReference](https://github.com/i-moonlight/NSwag/wiki/ServiceProjectReference) tags in your .csproj (preview)
...
- [Add NSwag to your ASP.NET Core app](https://github.com/i-moonlight/NSwag/wiki/AspNetCore-Middleware)
...
- ASP.NET Web API assembly to OpenAPI (supports .NET Core)
  - [AspNetCoreOpenApiDocumentGenerator](https://github.com/i-moonlight/NSwag/wiki/AspNetCoreOpenApiDocumentGenerator)
  - [WebApiOpenApiDocumentGenerator](https://github.com/i-moonlight/NSwag/wiki/WebApiOpenApiDocumentGenerator)
    - Generates an OpenAPI specification for Web API controllers
  - [WebApiToOpenApiCommand](https://github.com/i-moonlight/NSwag/wiki/WebApiToOpenApiCommand)
    - Generates an OpenAPI specification for controllers in an external Web API assembly
    - [Also supports loading of .NET Core assemblies](https://github.com/i-moonlight/NSwag/wiki/Assembly-loading)
  - [TypesToOpenApiCommand](https://github.com/i-moonlight/NSwag/wiki/TypesToOpenApiCommand)
    - Generates an OpenAPI specification containing only types from .NET assemblies

**Code Generators:**

- **CSharp Client**
  - [CSharpClientGenerator](https://github.com/i-moonlight/NSwag/wiki/CSharpClientGenerator)
...
- **CSharp Controllers** (contract first/schema first development)
  - [CSharpControllerGenerator](https://github.com/i-moonlight/NSwag/wiki/CSharpControllerGenerator)
    - Generates Web API Controllers based on a OpenAPI specification (ASP.NET Web API and ASP.NET Core)
- **TypeScript Client**
  - [TypeScriptClientGenerator](https://github.com/i-moonlight/NSwag/wiki/TypeScriptClientGenerator)
...
- [Download latest **NSwagStudio MSI installer (NSwagStudio.msi)**](https://github.com/i-moonlight/NSwag/releases) (Windows Desktop application)
- [Download latest **NSwag command line tools** and NSwagStudio (NSwag.zip)](https://github.com/i-moonlight/NSwag/releases)
...
- **[NSwag.Core](https://apimundo.com/organizations/nuget-org/nuget-feeds/public/packages/NSwag.Core/versions/latest)**
  - The OpenAPI/Swagger reader and writer classes, see [OpenApiDocument](https://github.com/i-moonlight/NSwag/wiki/OpenApiDocument) (.NET Standard 1.0 / 2.0 and .NET 4.5)
...
- **[NSwag.Generation.WebApi](https://apimundo.com/organizations/nuget-org/nuget-feeds/public/packages/NSwag.Generation.WebApi/versions/latest)** (.NET Standard 1.0 / 2.0 and .NET 4.5)
  - Classes to generate OpenAPI specifications from Web API controllers, see [WebApiOpenApiDocumentGenerator](https://github.com/i-moonlight/NSwag/wiki/WebApiOpenApiDocumentGenerator)
...
- **[NSwag.CodeGeneration.CSharp](https://apimundo.com/organizations/nuget-org/nuget-feeds/public/packages/NSwag.CodeGeneration.CSharp/versions/latest)** (.NET Standard 1.3 and .NET 4.5.1)
  - Classes to generate C# clients from OpenAPI specifications, see [CSharpClientGenerator](https://github.com/i-moonlight/NSwag/wiki/CSharpClientGenerator) and [CSharpControllerGenerator](https://github.com/i-moonlight/NSwag/wiki/CSharpControllerGenerator)
- **[NSwag.CodeGeneration.TypeScript](https://apimundo.com/organizations/nuget-org/nuget-feeds/public/packages/NSwag.CodeGeneration.TypeScript/versions/latest)** (.NET Standard 1.3 and .NET 4.5.1)
  - Classes to generate TypeScript clients from OpenAPI specifications, see [TypeScriptClientGenerator](https://github.com/i-moonlight/NSwag/wiki/TypeScriptClientGenerator)
...
- **[NSwag.AspNet.Owin](https://apimundo.com/organizations/nuget-org/nuget-feeds/public/packages/NSwag.AspNet.Owin/versions/latest)** (.NET 4.5+)
  - [ASP.NET Core/OWIN middlewares](https://github.com/i-moonlight/NSwag/wiki/Middlewares) for serving OpenAPI specifications and Swagger UI
- **[NSwag.AspNet.WebApi](https://apimundo.com/organizations/nuget-org/nuget-feeds/public/packages/NSwag.AspNet.WebApi/versions/latest)** (.NET 4.5+)
  - ASP.NET Web API filter which serializes exceptions ([JsonExceptionFilterAttribute](https://github.com/i-moonlight/NSwag/wiki/JsonExceptionFilterAttribute))
...
- **[NSwag.MSBuild](https://apimundo.com/organizations/nuget-org/nuget-feeds/public/packages/NSwag.MSBuild/versions/latest)** (MSBuild .targets):
  - Adds a .targets file to your Visual Studio project, so that you can run the NSwag command line tool in an MSBuild target, see [MSBuild](https://github.com/i-moonlight/NSwag/wiki/MSBuild)
...
To register the [middlewares](https://github.com/i-moonlight/NSwag/wiki/AspNetCore-Middleware) to generate a OpenAPI spec and render the UI, register NSwag in `Startup.cs`:
...
Check out the [project Wiki](https://github.com/i-moonlight/NSwag/wiki) for more information.

### NSwagStudio

The generators can be used in a comfortable and simple Windows GUI called [NSwagStudio](https://github.com/i-moonlight/NSwag/wiki/NSwagStudio):

[![](https://raw.githubusercontent.com/i-moonlight/NSwag/master/assets/screenshots/03_WebAPI_CSharp.png)](https://raw.githubusercontent.com/i-moonlight/NSwag/master/assets/screenshots/03_WebAPI_CSharp.png)
...
- [Sponsor main contributor Rico Suter via GitHub](https://github.com/sponsors/i-moonlight)
